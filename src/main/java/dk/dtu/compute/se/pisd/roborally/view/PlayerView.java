...
/**
 * Class responsible for the GUI that concerns a player:
 * His card and program fields along with buttons that can be clicked.
 *
...
public class PlayerView extends Tab implements ViewObserver {
     ...
     * @param gameController the GameController that handles the logic for the game.
     * @param player the player who needs a PlayerView to create a corresponding GUI.
     */
